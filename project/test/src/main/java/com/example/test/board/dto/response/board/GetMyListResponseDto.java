...
public class GetMyListResponseDto {
    ...
    public GetMyListResponseDto(ProductEntity productEntity) {
    ...
    public static List<GetMyListResponseDto> copy(List<ProductEntity> productEntityList) {
        List<GetMyListResponseDto> list = new ArrayList<>();

        for (ProductEntity productEntity: productEntityList) {
            GetMyListResponseDto dto = new GetMyListResponseDto(productEntity);
            list.add(dto);
        }
        return list;
    }
